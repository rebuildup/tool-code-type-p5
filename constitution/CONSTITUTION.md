# tool-code-type-p5 Constitution

この文書は、tool-code-type-p5 の開発組織における最上位 contract です。
...
tool-code-type-p5 の開発組織の目的は current procedure への服従ではありません。
...
This repository owns an embeddable my-web-2025 client component. Host and sibling UI checkout requirements are integration constraints and do not transfer ownership to this repository.
